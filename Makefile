# This Makefile is for the Data::Table::Excel extension to perl.
#
...
#     BUILD_REQUIRES => {  }
#     NAME => q[Data::Table::Excel]
#     PREREQ_PM => { Spreadsheet::ParseExcel=>q[0], Spreadsheet::XLSX=>q[0], Spreadsheet::WriteExcel=>q[0], Data::Table=>q[1.52], Excel::Writer::XLSX=>q[0] }
#     VERSION_FROM => q[Excel.pm]
...
MAKEMAKER   = /tools/GNU/perl/5.14.2/lib/5.14.2/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.57_05
MM_REVISION = 65705
...
INST_LIBDIR      = $(INST_LIB)/Data/Table
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Data/Table
...
DISTNAME = Data-Table-Excel
DISTVNAME = Data-Table-Excel-0.2
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Excel.pm $(INST_MAN3DIR)/Data::Table::Excel.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Data-Table-Excel' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Data::Table:          1.52' >> META_new.yml
	$(NOECHO) $(ECHO) '    Excel::Writer::XLSX:  0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Spreadsheet::ParseExcel:  0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Spreadsheet::WriteExcel:  0' >> META_new.yml
	$(NOECHO) $(ECHO) '    Spreadsheet::XLSX:    0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Data::Table" VERSION="1.52" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Excel::Writer::XLSX" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  Excel.pm $(INST_LIB)/Data/Table/Excel.pm 
